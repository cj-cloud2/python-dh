...
**Concept:** `ticker` controls the markers on the X and Y axes (the numbers and dashes). 
`text` and `annotations` allow you to write notes directly on the chart to explain data points.
